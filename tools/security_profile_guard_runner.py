...
SCENARIOS = (
    ...
    Scenario("development-plaintext-wifi-nvs", "PASS", ("ALGAGUARD_PHYSICAL_TEST_MODE=1", "ALGAGUARD_DEVELOPMENT_BUILD=1", "ALGAGUARD_ENV_DEVELOPMENT=1", "ALGAGUARD_DEVELOPMENT_PHYSICAL_TEST_OPT_IN=1", "ALGAGUARD_PRODUCTION_ELIGIBLE=0", "ALGAGUARD_DEVELOPMENT_WIFI_NVS_PLAINTEXT=1")),
    Scenario("production-with-plaintext-wifi-nvs", "FAIL", ("ALGAGUARD_DEVELOPMENT_BUILD=1", "ALGAGUARD_ENV_DEVELOPMENT=1", "ALGAGUARD_DEVELOPMENT_WIFI_NVS_PLAINTEXT=1", "ALGAGUARD_PRODUCTION_BUILD=1"), "ALGAGUARD_GUARD_PLAINTEXT_WIFI_NVS_DEVELOPMENT_ONLY"),
    Scenario("conflicting-wifi-storage-modes", "FAIL", ("ALGAGUARD_DEVELOPMENT_BUILD=1", "ALGAGUARD_ENV_DEVELOPMENT=1", "ALGAGUARD_PRODUCTION_ELIGIBLE=0", "ALGAGUARD_DEVELOPMENT_WIFI_NVS_PLAINTEXT=1", "ALGAGUARD_WIFI_CREDENTIAL_PERSISTENCE_DISABLED=1"), "ALGAGUARD_GUARD_WIFI_STORAGE_MODES_MUTUALLY_EXCLUSIVE"),
